...
public class Employee  implements Comparable<Employee>{
    ...
    public String toString() {
        return  "employee id: " + getEmployeeId() + ", " +
                ...
                "employee role: " + getEmployeeRole().toString();
    }   
    ...
    public  static Comparator<Employee> EmpComparator= new Comparator<Employee>() {
        ...
        public int compare(Employee employee1, Employee employee2) {
            String employeeName1=employee1.getEmployeeName();
    ...
    public int compareTo(Employee employee) {
        int emplID=((Employee) employee).getEmployeeId();
        return this.employeeId-emplID;
