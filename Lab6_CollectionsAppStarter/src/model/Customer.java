  ...
  @Override
   ...
   public static  Comparator<Customer> CustComparator=new Comparator<Customer>() {
        ...
        public int compare(Customer customer1, Customer customer2) {
            String customer1Address=customer1.getCustomerAddress();
            String customer2Address= customer2.getCustomerAddress();
            
           return  customer1Address.compareTo(customer2Address);
